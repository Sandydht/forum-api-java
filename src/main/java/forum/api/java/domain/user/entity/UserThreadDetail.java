...
public class UserThreadDetail {
    private static final String notContainNeededPropertyErrorMessage = "USER_THREAD_DETAIL.NOT_CONTAIN_NEEDED_PROPERTY";
    private static final String containRestrictedCharacterErrorMessage = "USER_THREAD_DETAIL.USERNAME_CONTAIN_RESTRICTED_CHARACTER";
    private static final String limitCharErrorMessage = "USER_THREAD_DETAIL.USERNAME_LIMIT_CHAR";

    private final String id;
    private final String username;
    private final String fullname;

    public UserThreadDetail(String id, String username, String fullname) {
